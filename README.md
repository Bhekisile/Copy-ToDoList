...
**[To-Do-List(Copy)]** is a project about the list of tasks. The user can add, edit, and delete the task and each task is rendered dynamically on page load. The project uses webpack to bundle JavaScript files.
...
- [Live Demo Link](https://bhekisile.github.io/To-do-list/dist/)
